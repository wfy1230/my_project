...
__all__ = ['TransformerEncoderLayer_LocalWindowAttention', 'AIFI_LPE', 'TransformerEncoderLayer_DAttention', 'TransformerEncoderLayer_HiLo', 
           ...
           'TransformerEncoderLayer_MALA', 'TransformerEncoderLayer_EGSA', 'TransformerEncoderLayer_SWSA', 'TransformerEncoderLayer_DWMMSA', 
...
######################################## ACMMM2025 Pushing Trade-Off Boundaries: Compact yet Effective RemoteSensing Change Detection start ########################################
...
class TransformerEncoderLayer_EGSA(nn.Module):
    """Defines a single layer of the transformer encoder."""

    def __init__(self, c1, cm=2048, num_heads=8, dropout=0.0, act=nn.GELU(), normalize_before=False):
        """Initialize the TransformerEncoderLayer with specified parameters."""
        super().__init__()
        self.EGSA = EfficientGlobalSA(c1, heads=num_heads)
        # Implementation of Feedforward model
        self.fc1 = nn.Conv2d(c1, cm, 1)
        self.fc2 = nn.Conv2d(cm, c1, 1)
...
class TransformerEncoderLayer_DWMMSA(nn.Module):
    """Defines a single layer of the transformer encoder."""

    def __init__(self, c1, cm=2048, num_heads=8, dropout=0.0, act=nn.GELU(), normalize_before=False):
        """Initialize the TransformerEncoderLayer with specified parameters."""
        super().__init__()
        self.SWSA = DWM_MSA(c1, heads=num_heads)
        # Implementation of Feedforward model
        self.fc1 = nn.Conv2d(c1, cm, 1)
        self.fc2 = nn.Conv2d(cm, c1, 1)
...
class TransformerEncoderLayer_BinaryAttn(nn.Module):
    """Defines a single layer of the transformer encoder."""

    def __init__(self, c1, cm=2048, num_heads=8, dropout=0.0, act=nn.GELU(), normalize_before=False):
        """Initialize the TransformerEncoderLayer with specified parameters."""
        super().__init__()
        self.SWSA = BinaryAttention(c1, num_heads=num_heads)
        # Implementation of Feedforward model
        self.fc1 = nn.Conv2d(c1, cm, 1)
        self.fc2 = nn.Conv2d(cm, c1, 1)
...
class TransformerEncoderLayer_WCA(nn.Module):
    """Defines a single layer of the transformer encoder."""
...
class TransformerEncoderLayer_LCGA(nn.Module):
    """Defines a single layer of the transformer encoder."""
...
class TransformerEncoderLayer_CGTA(nn.Module):
    """Defines a single layer of the transformer encoder."""

    def __init__(self, c1, cm=2048, num_heads=8, dropout=0.0, act=nn.GELU(), normalize_before=False):
        """Initialize the TransformerEncoderLayer with specified parameters."""
        super().__init__()
        self.SWSA = CGTA(c1, num_heads=num_heads)
        self.fc1 = nn.Conv2d(c1, cm, 1)
        self.fc2 = nn.Conv2d(cm, c1, 1)
